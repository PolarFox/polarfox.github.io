(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://pages.polarfox.net/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://pages.polarfox.net/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://pages.polarfox.net/assets/css/just-the-docs-' + theme + ".css"
      );
    };
